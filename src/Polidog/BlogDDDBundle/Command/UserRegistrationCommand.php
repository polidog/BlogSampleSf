...
namespace Polidog\BlogDDDBundle\Command;
...
class UserRegistrationCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('polidog_blog_ddd:user_registration');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $registerUser = $this->getContainer()->get('polidog_blog_ddd.use_case.register_user');
